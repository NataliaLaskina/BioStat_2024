...
observed_f_value <- 0.25  # Замените на ваше реальное наблюдаемое значение
...
t1 <- 55 # Средняя продолжительность болезни в группе 1
t2 <- 68 # Средняя продолжительность болезни в группе 2
...
observed_chi_squared <- 3.64  # Замените на ваше реальное наблюдаемое значение
